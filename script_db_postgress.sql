...
CREATE SEQUENCE db_empresa.administrador_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE db_seguridad.guardias_id_guardia_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE dbemergency.emergency_id_emergency_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE dbequipos.equipo_id_equipo_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
-- Crear secuencia notifica_id_notificacion_seq
CREATE SEQUENCE dbnotifica.notifica_id_notificacion_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
-- Crear secuencia passwords_id_seq
CREATE SEQUENCE dbusers.passwords_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
-- Crear secuencia users_id_seq
CREATE SEQUENCE dbusers.users_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE

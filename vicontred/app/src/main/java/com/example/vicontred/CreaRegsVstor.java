...
public class CreaRegsVstor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crea_regs_vstor);
    ...
    public void execCreaVisita(View view) {
    ...
    public void execCancelar(View view) {
        // Intent nextActivy = new Intent(this, UseryEmpra.class);
        // Intent nextActivy = new Intent(this, CreaSeguriMain.class);
        /// basefragmento UseryEmpra
        // startActivity(nextActivy);

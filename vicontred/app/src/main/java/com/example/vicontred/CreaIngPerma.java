...
public class CreaIngPerma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crea_ing_perma);
    ...
    public void execRegPermanente(View view) {
    ...
    public void execCancelaRegistro(View view) {
        // Intent nextActivy = new Intent(this, UseryEmpra.class);
        // Intent nextActivy = new Intent(this, CreaSeguriMain.class);
        /// basefragmento UseryEmpra
        // startActivity(nextActivy);
